...
namespace FintechCalculator.DataModels
{
	public class Prs
	{
		...
		public string has_logo { get; set; }
		...
		public int? canalization { get; set; }
		...
		public string pathway_json { get; set; }
		public int? homeselfie { get; set; }
		public string seo_title_json { get; set; }
		public string seo_name_json { get; set; }
	}
}
